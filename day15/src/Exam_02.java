...
class MyFrame02 extends Frame implements ActionListener{
	...
	public void paint(Graphics g) {
		...
		// polygon과 polyline의 차이점은 마지막 선을 완성한다 안한다의 차이
		g.drawPolyline(x, y, 3);
		
		g.setFont(new Font("", Font.BOLD, 30));		
		g.drawString("쪽", 50, 200);
		
		Image img = Toolkit.getDefaultToolkit().getImage("cww.jpg");
		g.drawImage(img, 50, 50, 100, 100, this);
		
		Image img2 = Toolkit.getDefaultToolkit().getImage("cww2.png");
		g.drawImage(img2, 200, 50, 100, 100, this);
