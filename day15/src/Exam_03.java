...
class MyImage03 extends Canvas{ // 이미지 객체를 만들어서 처리
	private Image img;
	private int x, y;
...
class MyFrame03 extends Frame implements ActionListener{
	...
	private Image img = Toolkit.getDefaultToolkit().getImage("cww.jpg");
	...
	@Override
	public void actionPerformed(ActionEvent e) { // mi라는 이름으로 객체 만들어 다루기
		if (e.getSource()==bt1) {
			mi.setX(mi.getX() + 50);
