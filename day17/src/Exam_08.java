...
class MyFrame08 extends Frame implements ActionListener, Runnable{
	private MyButton08 mbt[] = new MyButton08[9];
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==start_bt) {
			...
			isEnable = true;
			buttonSetting();
			Thread th = new Thread(this); //Runnable을 상속받은 객체를 넣어준다(this)
			th.start();
			dudu();
		}else {
			for(int i=0; i<mbt.length; ++i) {
...
public class Exam_08 {
	public static void main(String[] args) {
		MyFrame08 mf = new MyFrame08("두더지게임");
	}
}